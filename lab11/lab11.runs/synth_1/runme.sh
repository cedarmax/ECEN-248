...
HD_PWD='/home/cedar/lab11/lab11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc_fsm_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tlc_fsm_tb.tcl
