...
HD_PWD='/home/cedar/lab11/lab11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tlc_fsm_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tlc_fsm_tb.tcl -notrace
